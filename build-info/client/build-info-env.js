...
async function main() {
  ...
  environmentFile = replaceEnvironmentValue(environmentFile, 'version', `'${packageJson.version}'`);
  environmentFile = replaceEnvironmentValue(
    environmentFile,
    'buildTimestamp',
  ...
  environmentFile = replaceEnvironmentValue(environmentFile, 'commitId', `'${latestCommit.hash}'`);
  environmentFile = replaceEnvironmentValue(
    environmentFile,
    'commitTime',
