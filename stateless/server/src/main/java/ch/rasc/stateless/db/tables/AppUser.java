...
public class AppUser extends TableImpl<AppUserRecord> {
    ...
    private static final long serialVersionUID = -1189222239;
     ...
     */
    public final TableField<AppUserRecord, String> EMAIL = createField("EMAIL", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>APP_USER.PASSWORD_HASH</code>.
     */
    public final TableField<AppUserRecord, String> PASSWORD_HASH = createField("PASSWORD_HASH", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>APP_USER.AUTHORITY</code>.
     */
    public final TableField<AppUserRecord, String> AUTHORITY = createField("AUTHORITY", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>APP_USER.ENABLED</code>.
     */
    public final TableField<AppUserRecord, Boolean> ENABLED = createField("ENABLED", org.jooq.impl.SQLDataType.BOOLEAN, this, "");
